...
def move_group_python_interface_tutorial():
    ...
    rospy.Subscriber('gazebo/model_states', ModelState, ModelStatecallback, queue_size=10)
    rospy.spinOnce()
    ...
    rospy.Subscriber('gazebo/model_states', ModelState, sub_cal, queue_size=10)
    rospy.spinOnce()
    ...
    p.pose.position.x = 0.622141
    p.pose.position.y = 0.386952
    p.pose.position.z = 0
    scene.add_box("table", p, (0.5, 0.5, 1.4))
    #   p.pose.position.x = -0.5
    #   p.pose.position.y = -0.5
    #   p.pose.position.z = 0.7
    p.pose.position.x = -0.380787
    p.pose.position.y = -0.558841
    p.pose.position.z = 0
