...
if __name__ == '__main__':
    ...
    with open("/home/filippo/catkin_ws/src/hello_ros/urdf/cube.urdf", "r") as f:
        product_xml = f.read()
    ...
    for num in xrange(1,num_of_cubes+1):
    ...
    with open("/home/filippo/catkin_ws/src/hello_ros/urdf/bucket.urdf", "r") as f:
        product_xml = f.read()

    item_pose   =   Pose(Point(x=0.53, y=-0.23, z=0.78),orient)
    print("Spawning model:%s", "bucket")
    print("Position: %2f", item_pose)
